...
class CurrencyViewModel : ViewModel() {
    ...
    private val currencies: StateFlow<List<String>> get() = _currencies
    ...
    private fun loadCurrencies() {
        viewModelScope.launch {
            val currencyList = listOf(
                "EUR", "AED", "AFN", "ALL", "AMD", "ANG", "AOA", "ARS", "AUD", "AWG", "AZN", "BAM", "BBD", "BDT",
                "BGN", "BHD", "BIF", "BMD", "BND", "BOB", "BRL", "BSD", "BTN", "BWP", "BYN", "BZD", "CAD", "CDF",
                "CHF", "CLP", "CNY", "COP", "CRC", "CUP", "CVE", "CZK", "DJF", "DKK", "DOP", "DZD", "EGP", "ERN",
                "ETB", "FJD", "FKP", "FOK", "GBP", "GEL", "GGP", "GHS", "GIP", "GMD", "GNF", "GTQ", "GYD", "HKD",
    ...
    @Composable
    fun CurrencyListScreen(viewModel: CurrencyViewModel = this@CurrencyViewModel): ArrayList<String> {
        val currencies by viewModel.currencies.collectAsState()

        return currencies.toList() as ArrayList<String>
    }
}